...
function renderSessionList() {
    ...
    list.innerHTML = visible.map(s => {
        ...
        const cost = formatCost((s.jsonl_cost_usd && s.jsonl_cost_usd > 0) ? s.jsonl_cost_usd : s.estimated_cost);
    ...
    detail.innerHTML = `
        ...
        <div class="stats-row">
            <div class="stat-card">
                ...
                <div class="stat-value">${formatCost((session.jsonl_cost_usd && session.jsonl_cost_usd > 0) ? session.jsonl_cost_usd : session.estimated_cost)}</div>
            </div>
            <div class="stat-card">
